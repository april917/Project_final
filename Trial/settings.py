...
SECRET_KEY = 'django-insecure-#r1pp=#tygek6f*cy6u2prc14tgfjmtz0^wx3*zbcen@llxwa('
...
STATIC_URL = '/static/'
STATIC_ROOT = BASE_DIR / 'staticfiles'  # This can be any directory name of your choice
